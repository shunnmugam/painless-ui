...
describe('test input behaviour',() => {
    it('should render',() => {
        ...
        expect(() =>  renderer.render(<InputBox type='text' />)).not.toThrowError()
    })
...
describe('test input type',() => {
    ...
    it('test checkbox',() => {
        ReactDOM.render(<InputBox type='checkbox' />, div);
        const checkbox:any = div.querySelector('[type=checkbox]');
        expect(checkbox).not.toBeNull();
    })

    it('test radio',() => {
        ReactDOM.render(<InputBox type='radio' />, div);
        const checkbox:any = div.querySelector('[type=radio]');
        expect(checkbox).not.toBeNull();
    })

    it('test submit',() => {
        ReactDOM.render(<InputBox type='submit' />, div);
        const checkbox:any = div.querySelector('button[type=submit]');
        expect(checkbox).not.toBeNull();
    })

    it('test reset',() => {
        ReactDOM.render(<InputBox type='reset' />, div);
...
describe('test validation ',() => {
    ...
    it('check email validation',() => {
        ...
        ReactDOM.render(<InputBox type='email' 
            validation={true} validationOptions={validationOptions} 
            value='shunramit'
            onChange = {() => {}}
            />, div);

        const inputBox: any = div.querySelector('input[type=email]');
    ...
    it('check min validation',() => {
        ...
        ReactDOM.render(<InputBox type='text' 
            validation={true} validationOptions={validationOptions} 
            value='12'
            onChange = {() => {}}
            />, div);

        const inputBox: any = div.querySelector('input[type=text]');
        ReactTestUtils.Simulate.click(inputBox);
        expect(validationResult).not.toBeUndefined();
        expect(validationResult.isValidate).toBeFalsy();
    });
