...
var Button = function (props) {
    ...
    return (react_1.default.createElement("button", __assign({ "data-style-type": styleType, className: 'ui-button ripple ' + className + (rounded ? 'rounded' : ''), onClick: function (e) { return onClickHandler(e, props); } }, customProps, { style: __assign({
