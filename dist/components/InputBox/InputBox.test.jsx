...
describe('test validation ', () => {
    ...
    it('check email validation', () => {
        ...
        ReactDOM.render(<InputBox type='email' validation={true} validationOptions={validationOptions} value='shunramit' onChange={() => { }}/>, div);
    ...
    it('check min validation', () => {
        ...
        ReactDOM.render(<InputBox type='text' validation={true} validationOptions={validationOptions} value='12' onChange={() => { }}/>, div);
