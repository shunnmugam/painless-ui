...
class Select extends React.PureComponent {
    ...
    render() {
        ...
        return (<WatchClickOutside style={{ display: "initial" }} onClickOutside={() => this.toggle(false)}>
                <div onKeyDown={this.onKeyPressed} tabIndex={0} className="ui-select-container" style={{ maxWidth: width || '300px' }} {...customProps}>
